...
document = {
    cookie: "tt_webid=6942752934779438623; csrftoken=40de0381085f39b69ee587afc872df06; s_v_web_id=verify_kmlwq63d_HdNpTNYo_lfhM_4MQw_9hQO_OqzBJf65y2aG; MONITOR_WEB_ID=d22e4fd2-4665-4964-b910-ab8f9539a738; tt_scid=yDZgwEE3fsf2.VWPKCQQMFp3byThTqufu00AoqnVBMoTjgcdJsmqz.l-6J2EAAmL45b5",
    addEventListener: function (x) {
        // console.log("addEventListener的方法调用:",x)
        return {
...
location = {
    "ancestorOrigins": {},
    "href": "https://www.toutiao.com/c/user/token/MS4wLjABAAAAdJ0uPbIhuXwWgXzpsJh1KWK3fXDWU3kWfMqmlNqbNFs/",
    "origin": "https://www.toutiao.com",
    "protocol": "https:",
    "host": "www.toutiao.com",
    "hostname": "www.toutiao.com",
    "port": "",
    "pathname": "/c/user/token/MS4wLjABAAAAdJ0uPbIhuXwWgXzpsJh1KWK3fXDWU3kWfMqmlNqbNFs/",
    "search": "",
    "hash": ""
}
history = {}
...
window.sessionStorage = {
    "__tea_session_id_2256": "{\"sessionId\":\"53c11fb8-7ce4-442f-8abc-2c7f8b508ccd\",\"timestamp\":1616558018379}",
    "_byted_param_sw": "07oUvvs62y5xsqnqBSw=",
    "_tea_cache_duration": "{\"duration\":605178,\"page_title\":\"数据冰山的头条主页 - 今日头条(www.toutiao.com)\"}",
    "tt_scid": "3CcBdXYtkz95LH7TWVyzglwFz4jH1sxUFQR1crc6nwLpnkdfyhsoiQfEpAB7wBxYba68",
...
window.localStorage = {
    ...
    "__tea_cache_tokens_2018": "{\"web_id\":\"6942736144401745444\",\"ssid\":\"27ad9a5d-f757-4055-bd10-295f8ac4f750\",\"user_unique_id\":\"verify_kmlwq63d_HdNpTNYo_lfhM_4MQw_9hQO_OqzBJf65y2aG\",\"timestamp\":1616497313485}",
    "weather_city": "{\"city\":\"北京\",\"province\":\"北京\"}",
    "tt_scid": "3CcBdXYtkz95LH7TWVyzglwFz4jH1sxUFQR1crc6nwLpnkdfyhsoiQfEpAB7wBxYba68",
    "__tea_cache_tokens_2256": "{\"web_id\":\"6942412054054405662\",\"ssid\":\"d81d9eae-fddc-4f6a-ac60-1e70faa7732e\",\"user_unique_id\":\"6942412054054405662\",\"timestamp\":1616406270427}",
    "__tea_cache_first_2256": "1",
    "_byted_param_sw": "07oUvvs62y5xsqnqBSw=",
    "ttcid": "95d60e89974248429cfeff543a0af93028"
    ,
    getItem: function (name) {
        return this[name]
    },
...
(glb = "undefined" == typeof window ? global : window)._$jsvmprt = function (b, e, f) {
    ...
    m += 16, m += 8;
    var z = parseInt("" + b[m] + b[m + 1] + b[m + 2] + b[m + 3] + b[m + 4] + b[m + 5] + b[m + 6] + b[m + 7], 16), O = z,
        E = m += 8, j = v(b, m += z);
    j[1];
    m += 4, i = {p: [], q: []};
    for (var A = 0; A < j; A++) {
    ...
    var _ = {5: 1, 6: 1, 70: 1, 22: 1, 23: 1, 37: 1, 73: 1}, k = {72: 1}, M = {74: 1},
        H = {11: 1, 12: 1, 24: 1, 26: 1, 27: 1, 31: 1}, J = {10: 1}, N = {2: 1, 29: 1, 30: 1, 20: 1}, B = [], W = [];
...
function get_sign(url_) {
    //"https://www.toutiao.com/toutiao/api/pc/feed/?category=profile_all&utm_source=toutiao&visit_user_token=MS4wLjABAAAAmWcWyIWzrIhrj9-KxDUTVV3GWfXyDNTggj90GsKgNfM&max_behot_time=1576791904943"
    var a = {url: url_}
    return window.byted_acrawler.sign(a)
}

var url_ = 'https://www.toutiao.com/toutiao/api/pc/feed/?category=profile_all&utm_source=toutiao&visit_user_token=MS4wLjABAAAAmWcWyIWzrIhrj9-KxDUTVV3GWfXyDNTggj90GsKgNfM&max_behot_time=0'
console.log(window.byted_acrawler.sign({url: url_}))